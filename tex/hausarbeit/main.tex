...
%TODO detaillierter
Der Treiber deklariert neben den Funktionen auch hilfreiche Konstanten. 
...
Daten in einem FIFO werden über eine FIFO-Struktur gehalten, welche in der Datei \texttt{fifo.c} implementiert ist. Nachfolgend werden die Funktionen der \texttt{fifo.c} kurz vorgestellt:
