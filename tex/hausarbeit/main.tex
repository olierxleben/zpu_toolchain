...
\begin{tikzpicture}
	\node (recmark) [fill=green!20] at (0,0) {\texttt{:}}
		node (length) [fill=red!20,right=6pt] {\texttt{10}}
		node (address) [fill=yellow!20,right=6pt] {\texttt{0400}}
		node (content) [fill=blue!20,right=6pt] {\texttt{0b0b0b..}}
		node (checksum) [fill=purple!20,right=6pt] {\texttt{C3}};
\end{tikzpicture}
