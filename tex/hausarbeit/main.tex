...
\end{figure}
% TODO: überarbeiten
Die Hardware-Architektur der ZPU lässt sich in Abbildung \ref{zpu_architecture} veranschaulichen. Die Ein- und Ausgabe von Daten lassen sich über das Sende- und Empfangs-Fifo steuern. Zu beachten ist an dieser Stelle das die Fifos je nach Lage zum Empfangen oder Senden gedacht sind. Aus Sicht der ZPU werden Daten gesendet, wenn diese im Empfangs-Fifo landen und empfangen wenn diese in das Sende-Fifo geschrieben werden.  
