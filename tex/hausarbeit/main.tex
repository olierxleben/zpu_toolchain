...
Das Treibermodul stellt alle wichtigen Funktionen für die Hardware zur Verfügung. Dies sind neben den Basisfunktionen eines Treibers, wie z.B. \texttt{init} oder \texttt{mypci\_probe}, auch Funktionen zur Speicherverwaltung. Das Listing \ref{modzpu_functions} zeigt die Deklaration aus der \texttt{modzpu.h}

\begin{lstlisting}[language=C,firstnumber=47, label=modzpu_functions,caption=modzpu functions]
...
// Interrupt function
irqreturn_t myirq_handler(int irq, void *dev_id);\end{lstlisting}
